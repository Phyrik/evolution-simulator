...
def run():
    ...
    for i in range(1, STARTING_POPULATION_NUMBER + 1):
        population.append(evolution.Individual({"mutation_rate": 10, "vision_distance": 75, "eating_distance": 50, "violence": 10}, pop, [random.randrange(800), random.randrange(500)], {"survival_nutrition": 1, "replication_nutrition": 3, "kill_nutrition": 2}))
